...
export class ProfileComponent {
  ...
  info = [
    {
      id: 1,
      username: 'albertojativa0905@gmail.com',
      socialmedia: 'email',
      url: 'mail',
    ...
    {
      id: 2,
      username: 'Alberto Játiva',
      socialmedia: 'linkedin',
      url: 'https://www.linkedin.com/in/alberto-j%C3%A1tiva-375156234/',
